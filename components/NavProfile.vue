  ...
  <div class="mb-3 p-3 w-full cursor-pointer rounded-full hover:bg-twitterHoverColor duration-100 transition-colors">
    <div class="flex flex-row">
      ...
      <div class="basis-1/2 text-sm">
        <div class="font-extrabold">ramazan</div>
        <div class="text-slate-500 font-normal">@ramazanfb61</div>
      </div>
      <div class="basis-1/4 flex justify-center items-center text-lg w-fit h-fit">...</div>
    </div>
  </div>
</template>